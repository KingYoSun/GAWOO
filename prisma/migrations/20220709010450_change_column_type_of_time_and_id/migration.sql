/*
  ...
  - You are about to alter the column `id` on the `Notice` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  ...
  - You are about to alter the column `id` on the `Subscribe` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
