...
export default class AccountUtils {
  ...
  async authenticate() {
    await this.web3.wcClient.initConnection()
        .catch((e) => ErrorMsg.call(e));
    await this.web3.wcClient.setProvider()
        .catch((e) => ErrorMsg.call(e));
    ...
    const authProvider = new EthereumAuthProvider(this.web3.wcClient.provider, this.address);
    ...
    await this.idx.ceramic.did.authenticate()
        .catch((e) => ErrorMsg.call(e));
